...
const ChatApp = () => {
  ...
  return (
    ...
    >
      ...
      {/* Header */}
      <header className="w-full max-w-4xl px-4 py-6 relative">
        <h1 className="text-2xl font-bold text-center">AI Chat BYGXS</h1>
        <button
          onClick={toggleTheme}
      ...
      <header className="w-full max-w-4xl px-4 py-6 flex items-center justify-between">
        <h1 className="text-2xl font-bold ">AI Chat BYGXS</h1>
        <button
          onClick={toggleTheme}
